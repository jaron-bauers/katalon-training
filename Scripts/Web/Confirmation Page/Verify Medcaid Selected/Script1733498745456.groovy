...
WebUI.click(findTestObject('Object Repository/Make Appointment Page/label_Medicaid'))
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Confirmation Page/p_Medicaid'), 10)