...
WebUI.click(findTestObject('Object Repository/Make Appointment Page/label_Apply for hospital readmission'))
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Confirmation Page/p_Yes'), 10)