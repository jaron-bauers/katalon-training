...
WebUI.click(findTestObject('Object Repository/Confirmation Page/a_Go to Homepage'))

WebUI.verifyElementNotPresent(findTestObject('Object Repository/Confirmation Page/h2_Appointment Confirmation'), 10)